                ...
                if (userData && !error) {
                    ...
                    if (publishNav) {
                        if (userData.is_verified) {
                            publishNav.style.display = 'flex';
                            publishNav.classList.remove('disabled');
                        } else {
                            publishNav.style.display = 'none';
                            publishNav.classList.add('disabled');
                        }
                    }
        ...
        async function renderAddons(addons) {
            ...
            for (const addon of addons) {
                ...
                const verifiedIcon = userVerified ? '<svg viewBox="0 0 24 24" fill="none" style="width: 16px; height: 16px; margin-left: 4px; vertical-align: middle; filter: drop-shadow(0 0 8px rgba(46, 204, 113, 0.8));"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" stroke="#2ecc71" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="#2ecc71" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>' : '';
        ...
        searchInput.addEventListener('input', async function() {
            ...
            if (filtered.length > 0) {
                ...
                for (const addon of filtered) {
                    ...
                    const verifiedIcon = userVerified ? '<svg viewBox="0 0 24 24" fill="none" style="width: 14px; height: 14px; margin-left: 4px; vertical-align: middle; filter: drop-shadow(0 0 8px rgba(46, 204, 113, 0.8));"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" stroke="#2ecc71" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="#2ecc71" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>' : '';
                    html += `
